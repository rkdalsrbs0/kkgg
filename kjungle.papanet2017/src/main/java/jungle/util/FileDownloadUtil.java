...
public class FileDownloadUtil {
	...
	public  void download(HttpServletRequest request, HttpServletResponse response, String paramFileName, String oriFileName, String deleteYn, String idx) throws Exception {
		...
		File fis = new File(UPLOAD_PATH_PRE + idx + filename);
