	...
	<div class="container">
		...
		<colgroup>
			...
			<tr>
				...
				<td>
					<ul>
						<li>공모전의 주제와 적합한 내용인가?</li>
						<li>에너지절약 및 에너지신산업 주제에 대해 올바르게 이해한 작품인가?</li>
					</ul>
				</td>
				<td class="center"><span name="scorel1">30</span></td>
			...
			<tr>
				...
				<td>
					<ul>
					  ...
					  <td class="center"><span name="scorel2">30</span></td>
					...
					<tr>
					  <th class="t_green">파급력 및 시사성</th>
					  <td>
						<ul>
							<li>스토리를 통해 전달하려는 메시지가 명확한가?</li>
							<li>에너지절약 및 에너지신산업에 대하여 대중의 관심을 유발할 수 있는가?</li>
					...
					<tr>
					  ...
					  <td class="center"><span name="scorel4">10</span></td>
	...
	$(document).ready(function(){
	 ...
	 function valueCheck(){
			...
			if(isNaN(frmObj.score3.value)){ 
		    	alert("파급력 및 시사성 득점을 숫자로 입력해주세요.");
		    	frmObj.score3.focus();
		    	return false;
		    }
			...
			//최대 배점
			if(parseInt(frmObj.score1.value) > 30){ 
		    	alert("주체적 합성의 최대 득점은 30점 입니다.");
		    	frmObj.score1.focus();
		    	return false;
		    }
			if(parseInt(frmObj.score2.value) > 30){ 
		    	alert("창의성 및 흥미도 득점의 최대 득점은30점 입니다.");
		    	frmObj.score2.focus();
		    	return false;
		    }
			if(parseInt(frmObj.score3.value) > 30){ 
		    	alert("파급력 및 시사성 득점의 최대 득점은 30점 입니다.");
		    	frmObj.score3.focus();
		    	return false;
		    }
			if(parseInt(frmObj.score4.value) > 10){ 
		    	alert("작품성 및 완성도 득점의 최대 득점은 10점 입니다.");
		    	frmObj.score4.focus();
		    	return false;
		    }
			return true;
